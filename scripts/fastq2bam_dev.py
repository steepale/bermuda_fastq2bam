...
# Program files
trimmomatic = 'java -jar $TRIM/trimmomatic'
picard_readgroups = 'java -jar $PICARD/AddOrReplaceReadGroups.jar'
picard_sortsam = 'java -jar $PICARD/SortSam.jar'
picard_markdups = 'java -jar $PICARD/MarkDuplicates.jar'
picard_index = 'java -jar $PICARD/BuildBamIndex.jar'
picard_dict = 'java -jar $PICARD/CreateSequenceDictionary.jar'
gatk = 'java -cp $GATK -jar $GATK/GenomeAnalysisTK.jar'
